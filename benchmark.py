...
def main():
    ...
    cherry_data = load_lip_sync_data("/Users/seherova/Documents/projectss/speech-lip sync-sync/cherry-lip-sync/v04_cherry_ve_LipSync/cherry_catched_pattern_V04.txt")  # AI-based model
